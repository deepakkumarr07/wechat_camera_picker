...
class CameraPickerState extends State<CameraPicker>
  ...
  Widget buildCaptureButton(BoxConstraints constraints) {
    ...
    const Size innerSize = Size.square(60);
    return Semantics(
              ...
              children: <Widget>[
                Center(
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      color: innerController?.value.isRecordingVideo == true
                          ? Colors.transparent
                          : theme.canvasColor.withOpacity(0.85),
                      shape: BoxShape.circle,
                    ),
                    child: innerController?.value.isRecordingVideo == true
                        ? const Icon(
                            Icons.stop,
                            color: Color(0xFF81CD2B),
                            size: 50,
                          )
                        : const DecoratedBox(
                            decoration: BoxDecoration(
                ...
                CameraProgressButton(
                  ...
                  outerRadius: innerSize.width + 20,
      ...
      builder: (BuildContext context, BoxConstraints constraints) => Stack(
        ...
        children: <Widget>[
          ...
          if (controller.value.isRecordingVideo != true)
            Positioned(
                top: 40, left: 15, child: buildBackButton(context, constraints))
          else
            Container()
        ],
      ),
